...
namespace KeePassKeyWin.Core.Tests.Ipc
{
    public class VaultHandlerTests
    {
        ...
        public void CreatePasskey_ReturnsCredentialIdAuthDataAndPublicKey()
        {
            ...
            var result = (JObject)handler.Handle("keepasskeywin.createPasskey", new JObject
            {
                ["rpId"]            = "example.com",
                ["rpName"]          = "Example",
                ["userHandle"]      = "dXNlcjE",
        ...
        public void CreatePasskey_MissingRpId_Throws()
        {
            ...
            var ex = Assert.Throws<RpcException>(() =>
                handler.Handle("keepasskeywin.createPasskey", new JObject
                {
                    ["userHandle"] = "dXNlcjE",
                    ["userName"]   = "u",
                }));
        ...
        public void ListCredentials_ReturnsOnlyMatchingRpId()
        {
            ...
            var result = (JArray)handler.Handle("keepasskeywin.listCredentials", new JObject
                { ["rpId"] = "example.com" })!;
        ...
        {
            var handler = MakeHandler(out _);
            var result = (JArray)handler.Handle("keepasskeywin.listCredentials",
        ...
        public void SignAssertion_ReturnsVerifiableSignature()
        {
            ...
            var result = (JObject)handler.Handle("keepasskeywin.signAssertion", new JObject
            {
        ...
        public void SignAssertion_CredentialNotFound_Throws()
        {
            var handler = MakeHandler(out _);
            var ex = Assert.Throws<RpcException>(() =>
                handler.Handle("keepasskeywin.signAssertion", new JObject
                {
        ...
        public void DeleteCredential_ReturnsTrueWhenFound()
        {
            ...
            var result = (JObject)handler.Handle("keepasskeywin.deleteCredential",
        ...
        public void EnumerateForSync_ReturnsAllRecords()
        {
            ...
            var result = (JArray)handler.Handle("keepasskeywin.enumerateForSync", null)!;
        ...
        public void UnknownMethod_ThrowsMethodNotFound()
        {
            var handler = MakeHandler(out _);
            var ex = Assert.Throws<RpcException>(() =>
                handler.Handle("keepasskeywin.unknownMethod", null));
