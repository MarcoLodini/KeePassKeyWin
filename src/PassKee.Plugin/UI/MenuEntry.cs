...
{
    /// <summary>
    /// Adds a "PassKee" item to the KeePass Tools menu with sub-items for About,
    ...
    internal sealed class MenuEntry
    {
        ...
        {
            _rootItem = new ToolStripMenuItem("PassKee");

            var about = new ToolStripMenuItem("About PassKee...");
            about.Click += (_, _) =>
            {
            ...
            osCompat.Click += (_, _) =>
            {
                ...
                string msg = ok
                    ? "Your OS meets PassKee requirements."
                    : reason;
                MessageBox.Show(msg, "PassKee — OS Compatibility",
        ...
        private void ShowPasskeysGroup()
        {
            ...
            MessageBox.Show("No Passkeys folder found in the current database.",
                "PassKee", MessageBoxButtons.OK, MessageBoxIcon.Information);
        }
    }
}
#endif
