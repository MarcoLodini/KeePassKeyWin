...
namespace KeePassKeyWin.Harness.Pipe
{
    /// <summary>
    /// JSON-RPC 2.0 client over a named pipe to the KeePassKeyWin plugin.
    ...
    public sealed class PipeClient : IAsyncDisposable
    {
        ...
        /// <summary>Performs the keepasskeywin.hello handshake with the plugin.</summary>
        public async Task HandshakeAsync(string handshakeNonce, CancellationToken ct = default)
        {
            await CallAsync("keepasskeywin.hello", new JObject
            {
